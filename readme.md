...
- [PRISM_Recruitment_&_Legal_Docs/Recruitment_Message/Member_B.txt](PRISM_Recruitment_&_Legal_Docs/Recruitment_Message/Member_B.txt) — Frontend Lead template (20% equity example)
- [PRISM_Recruitment_&_Legal_Docs/Recruitment_Message/Member_C.txt](PRISM_Recruitment_&_Legal_Docs/Recruitment_Message/Member_C.txt) — Backend (Payments & Compliance) template (20% equity example)
